...
public class ConfigGenerator extends Generator {
    ...
    public ConfigGenerator(Config config, GeneratorConfig gConfig, Table table) {
    ...
    public void generate() {
        try {
            ...
            TemplateModel template = new TemplateModel(templateStr, ".xml", "/src/main/resources/mybatis/mapper/");
